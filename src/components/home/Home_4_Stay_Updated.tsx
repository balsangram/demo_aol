...
//       // Check if the translated data is available in localStorage
//       const cachedData = localStorage.getItem(`stayUpdated_${language}`);

//       console.log(cachedData, "cachedData", language);
...
//         setLoading(false);
//       } else {
//         // Fetch and translate data if not found in localStorage
//         console.log("start");
//         try {
...
//             `stayUpdated_${language}`,
//             JSON.stringify(translatedItems)
