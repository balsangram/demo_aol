...
import { RegisterUser } from "../../allapi/api";
...
const Register: React.FC = () => {
  ...
  const handleFlagError = (
    ...
    e.currentTarget.src = "https://flagcdn.com/24x18/in.png";
  };
      ...
      <div className="p-6 sm:p-8 rounded-xl w-full max-w-md bg-white shadow-xl">
        ...
        >
          ...
          <input
            ...
            className={`border-2 rounded-md px-4 py-2.5 bg-white text-[#0E1726] placeholder-[#5F99AE] text-sm sm:text-base ${
              errors.firstName ? "border-red-500" : "border-[#5F99AE]"
            }`}
          />
          {errors.firstName && (
          ...
          <input
            ...
            className={`border-2 rounded-md px-4 py-2.5 bg-white text-[#0E1726] placeholder-[#5F99AE] text-sm sm:text-base ${
              errors.lastName ? "border-red-500" : "border-[#5F99AE]"
            }`}
          />
          {errors.lastName && (
          ...
          {/* Email Field */}
          <div
            className={`flex items-center border-2 rounded-md px-4 py-2.5 bg-white transition-colors ${
              errors.email ? "border-red-500" : "border-[#5F99AE]"
            } focus-within:border-[#85cee2]`}
          >
          ...
          <div
            className={`flex items-center border-2 rounded-md px-4 py-2.5 bg-white transition-colors ${
              errors.phone ? "border-red-500" : "border-[#5F99AE]"
            } focus-within:border-[#85cee2]`}
          >
